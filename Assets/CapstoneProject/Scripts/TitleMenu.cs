...
{
    public void Start1P() { SceneManager.LoadScene("Singleplayer"); }
    ...
    void Start()
    {
        if (SceneManager.GetSceneByName("_MultiplayerLobby").isLoaded)
        {
            SceneManager.UnloadSceneAsync("_MultiplayerLobby");
        }
    }
}
